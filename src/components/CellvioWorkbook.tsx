  ...
  const steps = [
    {
      ...
      label: "Import Data",
      icon: IconFileImport,
      completed: !!importedData,
    },
    {
      id: "mapping",
      label: "Map Columns",
      icon: IconMapPin,
      completed: Object.keys(mappingState).length > 0,
    },
    {
      id: "review",
      label: "Review & Edit",
      icon: IconTable,
      completed: processedData.length > 0,
    },
  ];
                          ...
                          input.onchange = async (e) => {
                            ...
                            if (file) {
                              try {
                                ...
                                const { parseCSV, parseExcel } = await import(
