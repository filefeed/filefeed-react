...
const FileImport: React.FC<FileImportProps> = ({
  ...
  const handleFileReject = useCallback((fileRejections: any[]) => {
          ...
          <Dropzone.Idle>
            <div style={{ textAlign: 'center' }}>
              ...
              <Text size="md" c="gray.6" mb={16}>
                Upload CSV or Excel files up to {Math.round(maxFileSize / 1024 / 1024)}MB
              </Text>
              <Group justify="center" gap="sm">
                <Text size="sm" c="gray.5">Supported formats:</Text>
                <Group gap={4}>
                  <Text size="sm" fw={500} c="gray.7">.CSV</Text>
                  <Text size="sm" c="gray.4">•</Text>
                  <Text size="sm" fw={500} c="gray.7">.XLSX</Text>
                  <Text size="sm" c="gray.4">•</Text>
                  <Text size="sm" fw={500} c="gray.7">.XLS</Text>
                </Group>
              </Group>
            </div>
          </Dropzone.Idle>
